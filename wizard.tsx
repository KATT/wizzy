...
>(config: {
    ...
    type DataRequiredForStep<TStep extends $DataStep> 
      = Record<TStep, $Data[TStep]> & Omit<NonNullable<$PartialData>, TStep>
    type $GoToStepFunction = <TStep extends $AnyStep>(step: TStep, 
        ...args: 
            TStep extends $EndStepWithData
    ...
    function Wizard<TStart extends $Step,>(
        props: {
            id: string;
            start: TStart;
            }  & TStart extends $EndStepWithData ? { data: DataRequiredForStep<TStart> } : {}
        ) {
